...
The resultant plot is shown in Figure~\ref{example1-plot-expectations}.
...
The resultant plot is shown in Figure~\ref{example1-plot-simulations}.
...
Figure~\ref{example2-beta-plot-expectations} is a good facsimile of figure 2 in \citet{Minchin1987}.
